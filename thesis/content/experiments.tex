...
The key to meeting the four requirements in section~\ref{subsec:regexp_variant}, particularly the fourth requirement, was a mechanism called \textit{positive-lookahead}. This mechanism allows the engine to match the pattern as a sequence ahead of the current point, without actually consuming any of the matched characters. This was critical to finding overlapping matches.
...
As the results will show, the effectiveness of regular expressions varied.
